...
//Erstellt die Essensarten. Und lädt die, die bereits vom Nutzer ausgewählt wurden.
...
//Setzt die Hintergrundfarbe und den Titel der Navigationbar.
- (void)viewDidLoad
{
    [super viewDidLoad];
...
//Tippt der Nutzer auf eine Zelle, wird die dazugehörige Essensart an- oder abgewählt. Die Auswahl wird direkt
//in den UserDefaults gespeichert.
