...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    else
    {
        ...
        if (!_emptyState)
        {
            ...
            textView.text = NSLocalizedString(@"Du hast bisher keine Veranstaltung hinzugefügt. Füge Veranstaltungen über das Veranstaltungsverzeichnis oder den '+'-Button hinzu.", @"Du hast bisher keine Veranstaltung hinzugefügt. Füge Veranstaltungen über das Veranstaltungsverzeichnis oder den '+'-Button hinzu.");
