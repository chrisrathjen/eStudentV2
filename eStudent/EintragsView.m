...
//Der überschriebene Initializer setzt die übergebenen Instanzvariablen und setzt einen TapGestureRecognizer.
...
//Zeichnet den View für das UI aus dem Eintrag.
- (void)drawView
{
    float yOffset = 0.0;
    ...
    if (_kriterienCounter > 0) //Falls es zu einem Eintrag Kriterien gibt, wird die Anzahl angezeigt.
    {
...
//Setzt die 'Bestanden'-Grafik in Form eines Hakens, wenn der Eintrag bestanden ist. Ansonsten wird keine Grafik angezeigt.
...
//Fährt die Bearbeitungsleiste unter dem Eintrag aus.
- (void)showEditEntryView:(UITapGestureRecognizer *)sender
{
...
//Normalisiert ein übergebenes Datum.
- (NSDate *)normalizedDateWithDate:(NSDate *)date
{
