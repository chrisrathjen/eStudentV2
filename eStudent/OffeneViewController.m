...
@interface OffeneViewController ()
{
...
@implementation OffeneViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.tabBarController.title = NSLocalizedString(@"Offene Einträge", @"Offene Einträge");
...
- (void)loadView:(UIScrollView *)scrollView Studiengang:(Studiengang *)studiengang
{
    ...
    NSArray *semester = [[CoreDataDataManager sharedInstance] getAllOpenEntriesForStudiengang:studiengang];
