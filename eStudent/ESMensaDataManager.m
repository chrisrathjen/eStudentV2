...
+ (void)resetCache
{
    ...
    // uni
    [standartUserDefaults removeObjectForKey:@"uni"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"uni"] error:nil];
    // gw2
    [standartUserDefaults removeObjectForKey:@"gw2"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"gw2"] error:nil];
    // air
    [standartUserDefaults removeObjectForKey:@"air"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"air"] error:nil];
    // hsb
    [standartUserDefaults removeObjectForKey:@"hsb"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"hsb"] error:nil];
    // bhv
    [standartUserDefaults removeObjectForKey:@"bhv"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"bhv"] error:nil];
    // wer
    [standartUserDefaults removeObjectForKey:@"wer"];
    [defaultFileManager removeItemAtPath:[filePath stringByAppendingPathComponent:@"wer"] error:nil];
