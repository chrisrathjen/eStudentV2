...
//Erstellt ein Array mit den Mensen und wählt die Standardmensa nach den Einstellungen des Nutzers.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_isTableViewExpanded && indexPath.row > _selectedMensaIndex && indexPath.row < (_selectedMensaIndex + _essen.count + 1)) //wenn die Essen auch zusehen sind
    {
        ...
        cell.backgroundColor = [UIColor colorWithRed:.8 green:.8 blue:.8 alpha:1.0];
...
//Tippt der Nutzer auf eine Zelle, wird die entsprechende Mensa als Standard-Mensa gespeichert.
//Tippt der Nutzer auf eine Essenszelle unter der Mensa, wird das dazugehörige Essen als Lieblingsessen gespeichert.
