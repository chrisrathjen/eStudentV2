...
//Reagiert auf die Betätigung des 'Fertig' Button. Die gewählten Eintragsarten werden kombiniert und an den ParentViewController übertragen.
- (IBAction)fertigButtonPressed:(id)sender
{
...
//Der Nutzer betätigt den 'Bearbeiten' Button.
- (IBAction)bearbeitenButtonPressed:(id)sender
{
...
//Die Eintragsarten können alle bis auf eine gelöscht werden.
...
//Tippt der Nutzer auf eine Zelle wird die dazugehörige Eintragsart zur Auswahl hinzugefügt.
...
//Der Nutzer löscht eine Eintragsart.
...
//Die Anordnung der Eintragsarten kann auch verschoben werden.
...
//Legt der Nutzer selbst eine neue Eintragsart an, wird diese Art über die Betätigung des Return Keys der Tastatur gespeichert.
