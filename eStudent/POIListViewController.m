...
{
    // Deselektiert die angewählte Zelle, falls es eine gibt.
...
//Initialisiert das UI und lädt die POI-Daten über den Datenmanager.
- (void)viewDidLoad
{
    [super viewDidLoad];
    ...
    [self getCampusInformation]; //Fordert die POI-Daten an.
...
//Lädt die Kartenansicht mit den gefilterten POI.
...
//Wischt der Nutzer über eine Zelle wird er ebenfalls zu den Detailinformationen eines POI geleitet.
...
//Der Nutzer tippt auf eine der Zellen, wodurch der korrespondierende POI geladen wird.
...
//Lädt die POI-Daten über den Datenmanager.
...
//Lädt den aktuellsten POI-Datensatz vom Server.
...
//Zieht aus den POI-Daten die Anfangsbuchstaben raus und bereitet so die Daten für die Liste auf.
...
//Der Benutzer hat einen Suchbegriff in das Suchfeld eingegeben, nach der die POI-Liste gefiltert werden soll.
...
//Filtert die POI-Liste nach dem übergebenem Suchtext.
